            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 w-full">
                ...
                >
                    ...
                    <p className="text-gray-400 mb-8 max-w-md">
                        I&apos;m currently looking for new opportunities in Data Science and Artificial Intelligence. Whether you have a question or just want to say hi, I&apos;ll try my best to get back to you!
                    </p>
                ...
                >
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button
                            type="submit"
                            className="w-full bg-gradient-to-r from-primary to-secondary hover:opacity-90 text-white font-medium py-3 rounded-lg flex items-center justify-center gap-2 transition-all shadow-lg shadow-indigo-500/20"
                        >
                            {isSent ? "Message Sent!" : (
                                <>
